...
def train_model(train_dl: DataLoader, test_dl: DataLoader, model: nn.Module, epochs: int, learn_rate: float,
...
def predict_dist(model: nn.Module, data_fp: str, data_verif_fp: str, output_dir: str, x_filter: list,
    ...
    plt.clf()
    fig, ax = plt.subplots()
    ax.plot(1000 / df_train['parallax_corr'], 1000 / df_train['parallax_NN'], 'bx', alpha=0.1, ms=2)
    ax.plot(1000 / df_verif['parallax_corr'], 1000 / df_verif['parallax_NN'], 'gx', alpha=0.1, ms=2)
    ax.axline((0, 0), (1, 1), color='k')
    ax.set(xlabel='True [pc]', ylabel='Predicted [pc]')
    fig.tight_layout()
    ...
    plt.clf()
    fig, ax = plt.subplots()
    ax.plot(1000 / df_train_filtered['parallax_corr'], 1000 / df_train_filtered['parallax_NN'], 'bx', alpha=0.1, ms=2)
    ax.plot(1000 / df_verif_filtered['parallax_corr'], 1000 / df_verif_filtered['parallax_NN'], 'gx', alpha=0.1, ms=2)
    ax.axline((0, 0), (1, 1), color='k')
    ax.set(xlabel='True [pc]', ylabel='Predicted [pc]')
    fig.tight_layout()
    ...
    plt.clf()
    fig, ax = plt.subplots()
    ax.loglog(1000 / df_train['parallax_corr'], 1000 / df_train['parallax_NN'], 'bx', alpha=0.1, ms=2)
    ax.loglog(1000 / df_verif['parallax_corr'], 1000 / df_verif['parallax_NN'], 'gx', alpha=0.1, ms=2)
    ax.axline((0, 0), (1, 1), color='k')
    ax.set(xlabel='True [pc]', ylabel='Predicted [pc]')
    fig.tight_layout()
    ...
    plt.clf()
    fig, ax = plt.subplots()
    ax.loglog(1000 / df_train_filtered['parallax_corr'], 1000 / df_train_filtered['parallax_NN'], 'bx', alpha=0.1, ms=2)
    ax.loglog(1000 / df_verif_filtered['parallax_corr'], 1000 / df_verif_filtered['parallax_NN'], 'gx', alpha=0.1, ms=2)
    ax.axline((0, 0), (1, 1), color='k')
    ax.set(xlabel='True [pc]', ylabel='Predicted [pc]')
    fig.tight_layout()
